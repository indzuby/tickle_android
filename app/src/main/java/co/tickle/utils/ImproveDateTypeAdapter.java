 ...
 */
public final class ImproveDateTypeAdapter extends TypeAdapter<Date> {
    ...
    public static final TypeAdapterFactory FACTORY = new TypeAdapterFactory() {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
            ...
            TypeAdapter<T> typeAdapter = (TypeAdapter<T>) ((typeToken.getRawType() == Date.class) ? new ImproveDateTypeAdapter()
                    : null);
            return typeAdapter;
        }
    };
